...
public class BHPLGame extends AbstractPageList {

    private final BHPlayer bwPlayer;

    public BHPLGame(PlayerBoard player, BHPlayer bwPlayer) {
        super(player);
    ...
    protected List<AbstractPage> createPages() {
        return List.of(new BHGamePage(this, this.bwPlayer));
    }

    public static class BHGamePage extends AbstractPage {
